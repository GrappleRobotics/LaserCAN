...
impl Default for LaserCanConfiguration {
  fn default() -> Self {
    Self {
      device_id: 0, long: false, roi: LaserCanRoi { x: LaserCanRoiU4(8), y: LaserCanRoiU4(8), w: LaserCanRoiU4(16), h: LaserCanRoiU4(16) }, timing_budget: 33, name: "LaserCAN".to_owned()
    }
  }
}
